...
" ---------- comments menu  ------------------------------------------------
"
 noremap    <buffer>  <silent>  <LocalLeader>ce         :call C_LineEndComment()<CR>
inoremap    <buffer>  <silent>  <LocalLeader>ce    <Esc>:call C_LineEndComment()<CR>a
vnoremap    <buffer>  <silent>  <LocalLeader>ce    <Esc>:call C_MultiLineEndComments()<CR>
